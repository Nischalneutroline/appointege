...
export default function NewPasswordForm() {
  ...
  if (error) {
    return (
      <div className=" bg-white rounded-2xl border border-slate-200 p-6 3xl:p-8 4xl:p-10 5xl:p-12 space-y-6 shadow-2xl">
        <div className="relative mb-8">
          <div className="w-20 h-20 3xl:w-24 3xl:h-24 4xl:w-28 4xl:h-28 5xl:w-32 5xl:h-32 bg-gradient-to-br from-red-100 to-red-200 rounded-2xl flex items-center justify-center mx-auto shadow-lg relative">
            <HiOutlineExclamationTriangle className="w-10 h-10 3xl:w-12 3xl:h-12 4xl:w-14 4xl:h-14 5xl:w-16 5xl:h-16 text-red-600 animate-bounce" />

            {/* Floating sparkles */}
            <Sparkles className="w-4 h-4 3xl:w-5 3xl:h-5 4xl:w-6 4xl:h-6 5xl:w-7 5xl:h-7 text-red-500 absolute -top-2 -right-2 animate-pulse" />
            ...
            <Sparkles className="w-3 h-3 3xl:w-4 3xl:h-4 4xl:w-5 4xl:h-5 5xl:w-6 5xl:h-6 text-red-400 absolute top-2 -left-3 animate-pulse delay-700" />
          </div>

          {/* Ripple effect */}
          <div className="absolute inset-0 w-20 h-20  3xl:w-24 3xl:h-24 4xl:w-28 4xl:h-28 5xl:w-32 5xl:h-32 mx-auto rounded-2xl border-2 border-red-300 animate-ping opacity-20" />
          <div className="absolute inset-0 w-20 h-20 3xl:w-24 3xl:h-24 4xl:w-28 4xl:h-28 5xl:w-32 5xl:h-32 mx-auto rounded-2xl border border-red-200 animate-ping opacity-30 delay-300" />
        </div>

        <div className="text-center flex flex-col gap-1 3xl:gap-2">
        ...
        <div className="flex flex-col gap-4 ">
          <div className="bg-red-50/50 border border-red-200/50 rounded-xl p-4 text-left space-y-3">
            <h3 className="font-medium text-red-800  text-center text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl">
              Try the following:
            </h3>
            <ul className="text-red-700 text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl gap-1 flex flex-col items-start ">
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 3xl:w-2 3xl:h-2 4xl:w-2.5 4xl:h-2.5 5xl:w-3 5xl:h-3 rounded-full bg-red-500 mt-2 flex-shrink-0" />
          ...
          <div className="space-y-6">
            ...
            >
              <RefreshCw className="w-5 h-5 3xl:w-8 3xl:h-8 4xl:w-10 4xl:h-10 5xl:w-12 5xl:h-12 mr-2 group-hover:rotate-180 transition-transform duration-300" />
            ...
            <div className="text-center">
              <Link
                href="/login"
                className="flex justify-center text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl text-sky-600 hover:text-sky-700 font-semibold transition-colors cursor-pointer"
              >
                <ArrowLeft className="w-4 h-4 3xl:w-5 3xl:h-5 4xl:w-6 4xl:h-6 5xl:w-7 5xl:h-7 mr-2" />
                Back to Login
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-gradient-to-r from-green-50/50 to-sky-50/50 rounded-xl p-4 border border-green-200/30 space-y-1 ">
            <div className="flex items-center justify-center space-x-2">
              <Calendar className="w-4 h-4 3xl:w-5 3xl:h-5 4xl:w-6 4xl:h-6 5xl:w-7 5xl:h-7 text-sky-600" />
              <span className="font-medium text-slate-700 text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl">
                Your Appointege account is ready!
              </span>
            </div>
            <p className="text-slate-600 text-xs 3xl:text-sm 4xl:text-base 5xl:text-lg text-center">
          ...
          <Link
            href="/login"
            className="flex justify-center text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl text-sky-600 hover:text-sky-700 font-semibold transition-colors"
          >
            <ArrowLeft className="w-4 h-4 3xl:w-5 3xl:h-5 4xl:w-6 4xl:h-6 5xl:w-7 5xl:h-7 mr-2" />
            Back to Login
          </Link>
  ...
  return (
    <div className="bg-white rounded-2xl 3xl:rounded-3xl 4xl:rounded-4xl 5xl:rounded-5xl border border-slate-200 p-6 3xl:p-7 4xl:p-8 5xl:p-10 space-y-6 3xl:space-y-7 4xl:space-y-8 5xl:space-y-10 shadow-2xl">
      <div className="text-center flex flex-col gap-1">
        <h2 className="text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl text-slate-800  -tracking-[0.020rem] font-extrabold">
          Set New Password
        </h2>
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="bg-sky-50/50 border border-sky-200/50 rounded-xl p-4">
              <p className="text-sky-800 text-sm 3xl:text-base 4xl:text-lg 5xl:text-xl font-medium mb-2">
                Password Requirements:
              </p>
              <div className="space-y-1">
                <div className="flex items-center space-x-2 text-xs 3xl:text-sm 4xl:text-base 5xl:text-lg">
                  <div
                    className={`w-1.5 h-1.5 3xl:w-2 3xl:h-2 4xl:w-2.5 4xl:h-2.5 5xl:w-3 5xl:h-3 rounded-full ${
