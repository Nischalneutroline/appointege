...
//       const response = (await axiosApi.get('/api/appointment')) as AxioxResponseType<
//         Appointment[]
//       >
...
//     try {
//       const response = await axiosApi.post('/api/appointment', appointmentData)
//       const { data, success, errorDetail, message } = response.data
//       if (success && data) {
...
//     try {
//       const response = await axiosApi.put(`/api/appointment/${id}`, data)
//       const {
//         data: responseData,
//         success,
//         errorDetail,
...
//   try {
//     const response = await axiosApi.delete(`/api/appointment/${id}`)
...
//     // Update counts for all filter types
