...
// export const { setActiveStep, completeStep, resetBusinessState } =
//   businessSlice.actions

// // export const selectActiveStep = (state: { business: BusinessState }) =>
// //   state.business.activeStep

// // export const selectCompletedSteps = (state: { business: BusinessState }) =>
// //   state.business.completedSteps

// // export const selectAllSteps = (state: { business: BusinessState }) =>
// //   state.business.steps
