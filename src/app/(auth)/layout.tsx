...
const AuthLayout = ({ children }: AuthLayoutProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-white relative overflow-hidden">
      ...
      <div className="flex-1 lg:w-1/2 xl:w-2/5 flex items-center justify-center px-4 py-4 lg:py-8 2xl:py-20  ">
