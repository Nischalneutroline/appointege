        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex gap-8 items-center">
            ...
            <div className="flex gap-2 items-center h-full">
              <button
                className="flex items-center h-10 p-3 rounded-md bg-[#2563EB] text-white active:scale-95  gap-2"
                ...
                <div className="text-[#9F9C9C] text-sm font-medium">
                  {searchQuery ? (
                    <>
                      ...
                      {activeFilter === 'ALL'
                        ? 'all tickets'
                        : `${capitalizeFirstLetter(activeFilter)} Admin tickets`}
                      .
                    </>
                  ) : (
                    <>
                      ...
                      {activeFilter === 'ALL'
                        ...
                        : activeFilter === 'IN_PROGRESS'
                          ? 'In Progress'
                          : `${capitalizeFirstLetter(activeFilter)} Admin ticket.`}
                    </>
                  )}
                  <button
