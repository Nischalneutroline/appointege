  ...
  return [
    {
      ...
      value: 'active',
      textColor: '#103064',
      count: customer.filter((apt: User) => apt.isActive === true).length,
      data: customer.filter((apt: User) => apt.isActive === true),
      border: '#DCE9F9',
      background: '#E9F1FD',
    ...
    },
    {
      ...
      value: 'inactive',
      textColor: '#4C3000',
      count: customer.filter((apt: User) => apt.isActive === false).length,
      data: customer.filter((apt: User) => apt.isActive === false),
      border: '#FFF3CD',
      background: '#FFF6E6',
